<template>
    <div id="article_pre_pos">
      <router-link class="post-turning-pre" :to="VUE_CTX+'/subject/p/'+prePos.preId+'.html'" v-if="prePos.preId">上一篇</router-link>
      <router-link class="post-turning-pos" :to="VUE_CTX+'/subject/p/'+prePos.posId+'.html'" v-if="prePos.posId">下一篇</router-link>
    </div>
</template>
